        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 flex-wrap">
            <h2 className="text-xl font-bold text-white truncate">
              {isGroupChat ? groupName : user?.name || user?.email}
            </h2>
            {isGroupChat && (
              <button
          ...
          {isGroupChat ? (
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-blue-500 text-sm">typing...</span>
            </div>
          ) : (
            <div className="flex items-center gap-2">
              <div className={`w-2 h-2 rounded-full ${onlineUsers.includes(user?._id || '') ? "bg-green-500" : "bg-gray-500"}`}></div>
              <span className={`text-sm ${onlineUsers.includes(user?._id || '') ? "text-green-500" : "text-gray-500"}`}>
